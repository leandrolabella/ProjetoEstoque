...
public class ItensVendaDao {
    ...
    public static void salvar(ItemVenda itemVenda)
        ...
        String sql = "INSERT INTO TBITEMVENDA(idVenda, idItem, nomeProduto, idProduto, qtdItens, valor, valorTotal) VALUES(?, ?, ?, ?, ?, ?, ?);";
    ...
    public static List<ItemVenda> obterItens(Integer id)
            throws Exception {
        String sql = "SELECT idVenda, idItem, nomeProduto, idProduto, qtdItens, valorTotal, valor FROM TBITEMVENDA WHERE idVenda =?";
